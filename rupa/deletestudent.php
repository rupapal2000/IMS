...
<?php
  ...
  {
   extract($_REQUEST);
   $q2="delete from `student` where `id`='$id2'";
    ...
    <?php include("include/header.php"); ?>
      ...
      <?php include("include/navbar.php"); ?>
        <div class="col-lg-9">
         ...
         <a href="deletestudent.php?id2=<?php echo $res[0]; ?>"><button type="button" class="btn btn-primary" name="btn1">Yes</button></a>
         <a href="allstudent.php"><button type="button" class="btn btn-primary" name="btn1">No</button></a>
         </form>
        </div>
      </div>
    </div>
