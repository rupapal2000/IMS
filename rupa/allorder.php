    ...
    <?php include("include/header.php"); ?>
      ...
      <?php include("include/navbar.php"); ?>
        <div class="col-lg-9">
              ...
              <input type="text"
                class="form-control mt-2" name="myinput" id="myinput" aria-describedby="helpId" placeholder="Search By Anything">
        ...
        <table class="table">
            ...
            <tbody id="mytable">
              ...
              <tr>
                ...
                <td><a href="partpayment.php?id=<?php echo "$res[0]"; ?>"><?php echo "$res4[1]"; ?></a></td>
                <td><?php echo "$res3[1]"; ?></td>
                <td><?php echo "$res[3]"; ?></td>
                <td><?php echo "$res[4]"; ?></td> 
                <td><?php echo "$res[5]"; ?></td> 
                <td>
                   <a name="" id="" class="btn btn-primary" href="editorder.php?id=<?php echo "$res[0]"; ?>" role="button">Edit</a>
                 </td>
             </tr>
             <?php 
                 }
