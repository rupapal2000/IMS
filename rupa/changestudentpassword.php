...
if(isset($_POST['btn1']))
{
    ...
    //receive all data
    extract($_POST);
    $q2="select * from `student` where `phone`='$phone' and `password`='$opassword'";
   ...
   else
   {
    //print_r($id ." ". $name." ".$duration." " .$fee);die();
     //queries string
        $q1="UPDATE `student` SET `password` = '$npassword' WHERE `phone` = '$phone';";
        //execution string
         ...
         <form action="" method="post" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" readonly
              class="form-control" name="phone" value="<?php echo $_SESSION['usr']; ?>" id="" aria-describedby="helpId" placeholder="">
